      ...
      <div className='flex justify-center relative my-20 z-10'>
        <div className='max-w-[60vw] flex flex-col items-center justify-center '>
          ...
          <TextGenerateEffect
            ...
            words=' Hi, I am a Full Stack Developer with a strong foundation in Data Structures and Algorithms (DSA)'
          />


          <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-lg'>
          building a high-performance Website with advanced features for an optimized user experience
          </p>
          <a href="#about">
            <MagicButton
              title="Show my work"
